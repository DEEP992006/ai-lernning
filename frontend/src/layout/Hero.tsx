...
const Hero = () => {
    return (
        <div className='grid grid-cols-12 h-full min-w-full pt-7 pb-17 my-9'>
            ...
            <div className="h-full col-span-5 flex flex-col pt-5 px-12">
                ...
                <div className='my-1'>
                    <a href='signin'>
                        <button className='bg-gradient-to-r from-blue-600 to bg-purple-600 text-white rounded-xl text-lg px-5 py-2 flex items-center gap-2 cursor-pointer'>
                            Start Learning Free
                            <MoveRightIcon />
                        </button>
                    </a>
